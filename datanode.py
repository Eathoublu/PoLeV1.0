...
class FirstUi(QMainWindow):  
    ...
    def init_ui(self):
        ...
        self._lable5.setGeometry(350, 50, 300, 25)
        ...
        self.btn4.setGeometry(310, 140, 125, 50)
        ...
        self.et2.setGeometry(430, 220, 75, 25)
        self.et2.setText('%')
    ...
    def append_echo(self):
        ...
        self._echo += """{} | {} | {}%
---------------------------------- 
        """.format(self.itemcount, time.time(), random.randint(95, 99))
        self.tb.setText(self._echo)
    ...
    def changeLanguage(self):
        ...
        if self.lang == 1:
            self.lang = 0
            self._lable4.setText('<h2>PoLe 示例</h2>')
            ...
            self.lang = 1
            self._lable4.setText('<h1>PoLe Demo</h1>')
